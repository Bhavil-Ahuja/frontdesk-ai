    ...
    <div className="p-5 md:p-8 space-y-6 animate-fade-in">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">Real-time snapshot of your AI agent</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <ChartCard title="New Unique Interactions" subtitle="Last 14 days — new callers per day">
          <ResponsiveContainer width="100%" height={220}>
        ...
        <ChartCard title="AI-Booked Appointments" subtitle="This week — by booking date">
          <ResponsiveContainer width="100%" height={220}>
      ...
      <div className="rounded-xl border border-indigo-100 dark:border-indigo-900/40 bg-indigo-50/60 dark:bg-indigo-950/20 p-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            <p className="text-sm font-semibold text-gray-900 dark:text-white">Your agent is learning</p>
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-0.5">
              Add more Business Info and FAQ entries to improve booking accuracy and reduce escalations.
            </p>
          </div>
        </div>
      </div>
