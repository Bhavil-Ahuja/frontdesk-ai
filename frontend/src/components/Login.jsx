...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-dental-50 via-gray-50 to-blue-50 p-4">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-xl shadow-gray-200/40 p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-dental-500 text-white rounded-lg text-sm font-medium hover:bg-dental-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
              {submitting ? (
          ...
          <div className="mt-6 pt-6 border-t border-gray-100 text-center">
            <p className="text-sm text-gray-500">
              ...
              <Link
                to="/register"
                className="font-medium text-dental-600 hover:text-dental-700 inline-flex items-center gap-1"
              >
                Get started
